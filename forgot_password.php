...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($email)) {
        ...
        if ($user) {
            // Generate 6-digit code and expiration (1 hour)
        ...
        $success = "If an account with that email exists, a password reset code has been sent.";
    }
}
?>
<!DOCTYPE html>
    ...
    <div class="main-container">
        ...
        <div class="login-container">
            ...
            <?php if ($success): ?>
                ...
                <a href="verify_code.php">Enter Reset Code</a>
            <?php elseif ($error): ?>
