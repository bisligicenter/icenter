...
<head>
  ...
  <style>
    ...
    /* Hide search bar in header for airpods page only */
    .search-container {
    ...
    <div class="dropdown-product-grid">
      ...
      if (count($products) === 0) {
          ...
          foreach ($products as &$product) { // Use reference to modify
              // Add default technical specifications for AirPods if not already set
              ...
              if ($brandLower === 'apple') {
                  $specs = [
                      ...
                      'display_output' => 'N/A',
                      'screen_size' => 'N/A',
                      'charging_port' => 'Lightning / MagSafe',
                      'material' => 'Plastic',
                      'chip' => 'Apple H1/H2 Chip',
                      'camera_feature' => 'N/A'
                  ];
